...
from dataset_2d import Segmentation2DDataset3ChannelInput
...
dataset_train = Segmentation2DDataset3ChannelInput(inputs_pt_train,inputs_ct_train, targets_train)#, transform=transforms)
dataset_valid = Segmentation2DDataset3ChannelInput(inputs_pt_valid, inputs_ct_valid, targets_valid)#, transform=transforms)
