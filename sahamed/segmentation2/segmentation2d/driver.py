...
from dataset_2d import Segmentation2DDataset3ChannelInputSMP
...
dataset_train = Segmentation2DDataset3ChannelInputSMP(inputs_pt_train,inputs_ct_train, targets_train)#, transform=transforms)
dataset_valid = Segmentation2DDataset3ChannelInputSMP(inputs_pt_valid, inputs_ct_valid, targets_valid)#, transform=transforms)
...
#%%
dataloader_train = DataLoader(dataset=dataset_train, batch_size=512, shuffle=True, pin_memory=True, num_workers=24)
dataloader_valid = DataLoader(dataset=dataset_valid, batch_size=512, shuffle=True, pin_memory=True, num_workers=24)
