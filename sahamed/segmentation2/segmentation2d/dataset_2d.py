...
from transformations import pt_preprocess, resize_2dtensor_bilinear,resize_2dtensor_nearest, trunc_scale_preprocess_pt, trunc_scale_preprocess_ct
# from transformations import *
# %%
# dataset class

class Segmentation2DDataset2ChannelInput(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # Resizing
        xpt = resize_2dtensor_bilinear(xpt, 128, 128)
        xct = resize_2dtensor_bilinear(xct, 128, 128)
        y = resize_2dtensor_nearest(y, 128, 128)
...
class Segmentation2DDataset3ChannelInputSMP(Dataset):
    def __init__(self, inputs_pt, inputs_ct, targets):
        self.inputs_pt = inputs_pt 
        self.inputs_ct = inputs_ct 
        self.targets = targets
